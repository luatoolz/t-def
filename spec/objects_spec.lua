...
--    assert.factory(simple)
  ...
  it("__add/__sub/__concat/__mod/__unm", function()
    ...
    assert.is_true(o*nil)
    assert.equal(0, o % {})
    local r = (o + '[{"_id":"66ef5a258aa5f11c0c094b25", "n":1},{"_id":"66ef5a258aa5f11c0c094b26", "n":2}]')
    assert.equal(2, r.nInserted+r.nUpserted)
    assert.equal(2, o % {})
    r = (o + o('[{"_id":"66ef5a258aa5f11c0c094b27", "n":3},{"_id":"66ef5a258aa5f11c0c094b28", "n":4}]'))
    assert.equal(2, r.nInserted+r.nUpserted)
    assert.equal(4, o % {})
    assert.is_true(o*nil)
    ...
    r = (o .. '[{"_id":"66ef5a258aa5f11c0c094b25", "n":1},{"_id":"66ef5a258aa5f11c0c094b26", "n":2}]')
    assert.equal(2, r.nInserted+r.nUpserted)
    assert.equal(2, o % {})
    r = (o .. o('[{"_id":"66ef5a258aa5f11c0c094b27", "n":3},{"_id":"66ef5a258aa5f11c0c094b28", "n":4}]'))
    assert.equal(2, r.nInserted+r.nUpserted)
  ...
  it("__concat", function()
    ...
    local r = (o .. {o({done=true, message='some', created=0})})
    assert.equal(1, r.nInserted+r.nUpserted)
    assert.equal(1, o % {})
    r = (o .. {{done=true, message='some', created=0}})
    assert.equal(1, r.nInserted+r.nUpserted)
    assert.equal(2, o % {})
